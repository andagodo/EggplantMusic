			...
			<div class="row">
                <div class="col-lg-3">
					...
					<form role="form" action='/includes/SAdmin/BajaAdmin.php' method="POST">
						...
						<button type="button" class="btn btn-default" onclick="ConsultaTipoAdminBaja();">Consultar</button>
					</form>
				</div>
				...
				<div class="col-lg-3">
					...
					<button type="button" class="btn btn-default" onclick="ConsultaAdminBaja();">Buscar</button>
				</div>

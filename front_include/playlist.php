...
{
	?>
<li><a href='<?php echo $datos_r[$i][3]?>'><?php echo $datos_r[$i][1]?></a><div class="btn2"><a href="#" class="btn1" onclick="mostrarMenu1(event)">+</a></div></li>
<?php
}
?>
</ul>
...
function initaudio(){current=0;
	...
	par=link.parent();par.addClass('active').siblings().removeClass('active');

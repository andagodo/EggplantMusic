...
<html lang="es">
	...
	<body id="page-top">
		...
		<script type="text/javascript" src="/estilos/portada/jquery/jquery.min.js"></script>
		<script type="text/javascript" src="/estilos/portada/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="/estilos/portada/jquery/jquery.easing.min.js"></script>
		<script type="text/javascript" src="/estilos/portada/js/scrollreveal.min.js"></script>
		<script type="text/javascript" src="/estilos/portada/js/jquery.magnific-popup.min.js"></script>
		<script type="text/javascript" src="/estilos/portada/js/creative.min.js"></script>
	</body>
</html>